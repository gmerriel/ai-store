# Lead Analyst Role: Nurture Stream Lead Analysis - Mortgage Brokers
...
1. Assess readiness for next step (booking call, application, pre-approval, etc.)
...
- Rate concerns: "Worried about rates rising" → Discuss fixed vs variable options
- Deposit concerns: "Don't have 20%" → Explain LMI, guarantor options, first home buyer grants
- Approval anxiety: "Will I even get approved?" → Reassure on process, broker's role
- Timing: "Maybe after bonus/tax return" → Confirm timeline
- Self-employed complexity: "My income is complicated" → Explain specialist lending
- Information gaps: "How does pre-approval work?" → Explain steps
...
- **AUTHORITY**: Share process expertise, demystify lending
